...
<head>
    ...
    <!-- logo tab -->
    <link href=" assets/logo.php" rel="shortcut icon">
    <title>Absensi Meeber</title>
    ...
    <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item ">
                    <a class="nav-link" href="?page=dataPegawai"><i class="fa fa-fw fa-address-card-o"></i> Data Pegawai</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?page=logHadir"><i class="fa fa-fw fa-book"></i> Log Hadir Pegawai</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?page=device"><i class="fa fa-fw fa-tablet"></i> Device Info</a>
                </li>
